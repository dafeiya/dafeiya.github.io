...
!function () {
    ...
    t.prototype._count = 0, t.prototype._createLink = function () {
        ...
        if ("lgslider" == this._type || "lgpreview" == this._type || !t.target.closest(".LGallery")) {
            ...
            setTimeout(function () {
                "lgslider" != e._type && "lgpreview" != e._type && (e._Gallery.classList.add("LGallery_open"),
                    document.body.classList.add("LGalleryBody_hidden")), e._renderSlider.call(e)
        ...
        function t(t) {
            "lgpreview" != W._type && (T[k].classList.remove("LGallerySlider-Slide_showing"), k = (t + T.length) % T.length, T[k].classList.add("LGallerySlider-Slide_showing"), W._Counter && (W._Counter.innerHTML = k + 1 + " / " + T.length)), "lgpreview" == W._type && (T[k].classList.remove("LGallerySlider-Slide_showing"), b[k].classList.remove("LGSliderWithPreview-Thumb_active"), k = t, t > T.length - 1 && (k = t - 1), t < 0 && (k = t + 1), T[k].classList.add("LGallerySlider-Slide_showing"), b[k].classList.add("LGSliderWithPreview-Thumb_active")), W._labels && (W._Label.classList.add("LGallerySlider-Label_hidden"), setTimeout(function () {
                W._Label.textContent = "", "" != W._labels[k] && void 0 != W._labels[k] && (W._Label.classList.remove("LGallerySlider-Label_hidden"), W._Label.textContent = W._labels[k])
            }, W._atime ? 1e3 * parseInt(W._atime) / 4 : 300)), W._descriptions && setTimeout(function () {
                W._LabelDescription.textContent = "", "" != W._descriptions[k] && void 0 != W._descriptions[k] && (W._Label.classList.remove("LGallerySlider-Label_hidden"), W._Label.appendChild(W._LabelDescription), W._LabelDescription.textContent = W._descriptions[k])
            }, W._atime ? 1e3 * parseInt(W._atime) / 4 : 300)
        }

        function e() {
            D.addEventListener("click", function (t) {
                f -= G + 2 * x, f < w && (f = w + 2 * x), w < 0 && (W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)")
            }), H.addEventListener("click", function (t) {
                f += +G + 2 * x, f > 0 && (f = 0), W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)"
            }), W._LGThumbs.onclick = function (t) {
                "IMG" == t.target.tagName && (t.clientX > C ? (f -= +G + 2 * x, f < w && (f = w + 2 * x), w < 0 && (W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)")) : t.clientX < C && (f += +G + 2 * x, f > 0 && (f = 0), this.firstElementChild.style.transform = "translateX(" + f + "px)"))
            };
        ...
        function s(t) {
            W._options.nobtns || void 0 == W._parent.dataset.lgnobtns && (t.classList.add("LGallerySlider-Button_clicked"), setTimeout(function () {
                t.classList.remove("LGallerySlider-Button_clicked")
            }, 220))
        }

        function l(e) {
            var i = W._parent.getBoundingClientRect().top >= -25,
                l = W._parent.getBoundingClientRect().bottom <= document.documentElement.clientHeight + 25;
            if ("lgallery" != W._type && "lgparent" != W._type || (i = W._Gallery.getBoundingClientRect().top >= -15, l = W._Gallery.getBoundingClientRect().bottom <= document.documentElement.clientHeight + 15), 37 == e.keyCode || 40 == e.keyCode) {
                if (W._keyboard && 40 == e.keyCode) return;
                i && l && (t(k - 1), s(H), "lgpreview" == W._type && (f += +G + 2 * x, f > 0 && (f = 0), W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)")), e.preventDefault()
            }
            if (39 == e.keyCode || 38 == e.keyCode) {
                if (W._keyboard && 38 == e.keyCode) return;
                i && l && (t(k + 1), s(D), "lgpreview" == W._type && (f -= +G + 2 * x, f < w && (f = w + 2 * x), w < 0 && (W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)"))), e.preventDefault()
            }
            27 == e.keyCode && (W._keyboard || v.call(W))
        }

        function n() {
            W._Play.classList.add("LGallery-PlayBtn_hidden"), W._Pause.classList.remove("LGallery-PauseBtn_hidden"), I = setInterval(function () {
                t(k + 1)
            }, M || 3e3)
        }

        function r() {
            W._Play.classList.remove("LGallery-PlayBtn_hidden"), W._Pause.classList.add("LGallery-PauseBtn_hidden"), clearInterval(I), I = null
        }

        function a(t) {
            t.target.closest(".LGallery-CloseBtn") && v.call(W), t.target.closest(".LGallery-PlayBtn") && n(), t.target.closest(".LGallery-PauseBtn") && r(), q || t.target.closest(".LGallerySlider-Slide") || t.target.closest(".LGallerySlider-Button") || t.target.closest(".LGallery-FullscreenBtn") || t.target.closest(".LGallery-PlayBtn") || t.target.closest(".LGallery-PauseBtn") || t.target.closest(".LGallery-Counter") || t.target.closest(".LGallerySlider-Label") || v.call(W)
        }

        function h() {
            N.x - P.x < -50 && (t(k + 1), "lgpreview" == W._type && (f -= G, f < w && (f = w), W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)")), N.x - P.x > 50 && (t(k - 1), "lgpreview" == W._type && (f += G, f > 0 && (f = 0), W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)"))
        }
        ...
        function d(t) {
            t.target.closest(".LGallerySlider-Label") || (N.x = t.clientX, N.y = t.clientY, h())
        }
        ...
        function c(t) {
            ...
            function i(t) {
                n - t.clientY > 150 || n - t.clientY < -150 ? (v.call(W), setTimeout(function (t) {
                    l.style.top = "50%"
        ...
        function _(t) {
            N.x = t.changedTouches[0].pageX, N.y = t.changedTouches[0].pageY, h()
        }
        ...
        function m(t) {
            ...
            function i(t) {
                n - t.changedTouches[0].pageY > 100 || n - t.changedTouches[0].pageY < -100 ? (v.call(W), setTimeout(function (t) {
                    l.style.top = "50%"
                }, 500)) : (l.classList.add("LGallerySlider-Slide_swiping"), l.style.top = "50%", setTimeout(function () {
                    l.classList.remove("LGallerySlider-Slide_swiping")
        ...
        function y(t) {
            var e, i, s = [W._ButtonPrev, W._ButtonNext, W._Fullscreen, W._Play, W._Pause];
        ...
        function L(t) {
            [W._ButtonPrev, W._ButtonNext, W._Fullscreen, W._Play, W._Pause].forEach(function (t) {
        ...
        var b, f, G, C, w, S, x, E = this, T = this._Slider.querySelectorAll(".LGallerySlider-Slide");
        this._Slider.querySelectorAll(".LGallerySlider-Label");
        if ("lgpreview" == this._type) {
            if (document.body.clientWidth, b = this._LGThumbsContainer.querySelectorAll("img"), f = 0, G = 50, this._thumbwidth && (G = +parseInt(this._thumbwidth)), x = 0, this._thumbmargin && (x = +parseInt(this._thumbmargin)), S = 450, this._thumbcontainer) {
            ...
            var B = function () {
                ...
                if (document.body.clientWidth > 1023) {
                    ...
                    S > E._parent.clientWidth && (S = E._parent.clientWidth), G = 50, E._thumbwidth && (G = +parseInt(E._thumbwidth));
                    for (var e = 0; e < b.length; e++) b[e].style.width = G + "px";
                ...
                if (document.body.clientWidth < 769) {
                    t = parseInt(getComputedStyle(E._LGThumbs).height), t > 100 && (t = 100), S > E._parent.clientWidth && (S = E._parent.clientWidth), G > 150 && (G = S / 4);
                    for (var i = 0; i < b.length; i++) b[i].style.width = G + "px";
                ...
                if (document.body.clientWidth < 415) {
                    t = parseInt(getComputedStyle(E._LGThumbs).height), t > 80 && (t = 80), G > 100 && (G = S / 3);
                    for (var s = 0; s < b.length; s++) b[s].style.width = G + "px";
                    E._LGThumbs.style.height = t + "px", E._Slider.setAttribute("style", "height: calc(100% - " + E._margin + " - " + t + "px) !important")
                }
            };
            B(), C = this._LGThumbs.getBoundingClientRect().left + S / 2, w = S - b.length * (G + 2 * x), window.addEventListener("resize", function () {
                B();
                var t;
                if (f == w + 2 * x && (t = 1), G = G, S = S, E._thumbcontainer) {
                    switch (E._thumbcontainer.slice(-1)) {
                        case"x":
                            S = +parseInt(E._thumbcontainer);
                            break;
                ...
                S > E._parent.clientWidth && (S = E._parent.clientWidth), E._LGThumbs.style.width = S + "px", w = S - b.length * (G + 2 * x), 1 == t && (f = w + 2 * x, W._LGThumbs.firstElementChild.style.transform = "translateX(" + f + "px)")
            }), w > 0 && (this._LGThumbs.firstElementChild.style.justifyContent = "center")
        }
        var k;
        "lgallery" != this._type && "lgslider" != this._type && "lgpreview" != this._type || (k = 0), "lgparent" == this._type && (k = this._src.indexOf(this._clickedLink)), T[k].classList.add("LGallerySlider-Slide_showing");
        var A, I, P = {}, N = {}, W = this, M = null;
        this._autoplay && (M = this._autoplay);
        var q, H = this._ButtonPrev, D = this._ButtonNext;
        ...
        function s(t) {
            N.x = t.changedTouches[0].pageX, N.y = t.changedTouches[0].pageY, W()
        }
        ...
        p <= 0 && (p = 1), c > r && (c = r);
        var p = h;
        for (p <= 0 && (p = 1), p > c && (p = c); r % p != 0;) p--;
        var _ = 0, u = d, m = o, g = u + 2 * m, y = g * c - 2 * m;
        ...
        for (var f = 0; f < r; f++) {
            var G = n[f].cloneNode(!0);
            G.ondragstart = function () {
                return !1
            }, this._LGCaruselSliderInner.append(G)
        }
        var C = g * r;
        this._LGCaruselSliderInner.style.transform = "translateX(-" + (C + m) + "px)";
        var w = 0, S = function () {
            if (document.body.clientWidth > 1170) {
                for (c = a, c > r && (c = r), p = h, p > c && (p = c); r % p != 0;) p--;
                m = o;
                var t = 2 * parseInt(getComputedStyle(l._LGCarusel.parentNode).paddingLeft);
                u = l._LGCarusel.parentNode.clientWidth / c - 2 * o - t / c, l._LGCarusel.parentNode.clientWidth / c - m > d && (u = d), g = u + 2 * m, y = g * c - 2 * m, C = g * r, _ = 0
            }
            if (document.body.clientWidth > 768 && document.body.clientWidth < 1171) {
                for (c = a, c > r && (c = r), c > 4 && (c = 4), p = h, p > c && (p = c); r % p != 0;) p--;
                m = o / 1.68;
                var e = 2 * parseInt(getComputedStyle(l._LGCarusel.parentNode).paddingLeft);
                u = l._LGCarusel.parentNode.clientWidth / c - o - e / c, g = u + 2 * m, y = g * c - 2 * m, C = g * r, _ = 0
            }
            if (document.body.clientWidth > 450 && document.body.clientWidth < 769) {
                for (c = a, c > r && (c = r), c > 2 && (c = 2), p > c && (p = c); r % p != 0;) p--;
                m = o / 3;
                var i = 2 * parseInt(getComputedStyle(l._LGCarusel.parentNode).paddingLeft);
                u = (l._LGCarusel.parentNode.clientWidth - o) / c - i / c, g = u + 2 * m, y = g * c - 2 * m, C = g * r, _ = 0
            }
            if (document.body.clientWidth < 450) {
                c = 1, p = 1, m = o / 4;
                var s = 2 * parseInt(getComputedStyle(l._LGCarusel.parentNode).paddingLeft);
                u = l._LGCarusel.parentNode.clientWidth - s / c, g = u + 2 * m, y = g * c - 2 * m, C = g * r, _ = 0
            }
        ...
        var E = function () {
            C += g * p, l._LGCaruselSliderInner.style.transform = "translateX(" + (-C - m) + "px)", _ += p, _ >= r && (w += g * n.length, l._LGCaruselSliderInner.style.marginLeft = w + "px", _ = 0), l._LGCaruselSliderInner.classList.add("LGCarusel-SliderInner_sliding"), setTimeout(function () {
        ...
        this._LGCaruselButtonNext.onclick = function (t) {
            E(), B(l._LGCaruselButtonNext)
        }, this._LGCaruselButtonPrev.onclick = function (t) {
            T(), B(l._LGCaruselButtonPrev)
        };
        var k, A = null;
        ...
        var I = function (t) {
            ...
            37 == t.keyCode && (e && i && (T(), B(l._LGCaruselButtonPrev)), t.preventDefault()), 39 == t.keyCode && (e && i && (E(), B(l._LGCaruselButtonNext)), t.preventDefault())
        };
        ...
        for (var c = document.querySelectorAll("[data-lgpreview]"), p = 0; p < c.length; p++) {
            t.prototype._lgpreviewoption.parent = c[p];
            if (c[p].querySelectorAll(".LGallerySlider").length) return;
            var _ = new t(t.prototype._lgpreviewoption);
            e.push(_)
        }
